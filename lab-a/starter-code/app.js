...
var productNumber = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + productNumber + '.'
